...
object NetworkModule {
        ...
        return OkHttpClient.Builder()
            ...
            .addInterceptor { chain ->
                val newRequest = chain.request().newBuilder()
                    .addHeader("User-Agent", "ComicApp/1.0")
                    .build()
    ...
    @Provides
    @Singleton
    fun provideComicVineApiService(retrofit: Retrofit): ComicVineApiService {
        return retrofit.create(ComicVineApiService::class.java)
    }
}